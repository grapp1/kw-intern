#!/bin/bash
## ParFlow install script for Ubuntu
## installing master version of ParFlow (not release)
...
git clone --single-branch --branch master --recursive https://github.com/parflow/parflow.git $ROOT/parflow/src
