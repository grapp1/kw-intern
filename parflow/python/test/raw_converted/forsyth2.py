...
forsyth2.ComputationalGrid.DX = [expr ($UpperX - $LowerX) / $NX]
forsyth2.ComputationalGrid.DY = [expr ($UpperY - $LowerY) / $NY]
forsyth2.ComputationalGrid.DZ = [expr ($UpperZ - $LowerZ) / $NZ]

#---------------------------------------------------------
# The Names of the GeomInputs
#---------------------------------------------------------
Zones = "zone1 zone2 zone3above4 zone3left4 \
                                      zone3right4 zone3below4 zone4"

forsyth2.GeomInput.Names = 'solidinput $Zones background'
...
forsyth2.Geom.domain.Patches = 'infiltration z_upper x_lower y_lower \'
...
#-----------------------------------------------------------------------------
forsyth2.BCPressure.PatchNames = [pfget Geom.domain.Patches]
...
forsyth2.TopoSlopesX.GeomNames = ''
...
forsyth2.TopoSlopesY.GeomNames = ''
