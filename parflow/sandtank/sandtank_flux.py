...
sandtank = Run('sandtank_flux', __file__)
...
sandtank.Cycle.Names = 'constant rainflux'
sandtank.Cycle.constant.Names = 'alltime'
sandtank.Cycle.constant.alltime.Length = 1
sandtank.Cycle.constant.Repeat = -1

sandtank.Cycle.rainflux.Names = 'rain rain_left rain_right dry1 dry2 dry3'

sandtank.Cycle.rainflux.rain.Length = 10
sandtank.Cycle.rainflux.dry1.Length = 10
sandtank.Cycle.rainflux.rain_left.Length = 10
sandtank.Cycle.rainflux.dry2.Length = 10
sandtank.Cycle.rainflux.rain_right.Length = 10
sandtank.Cycle.rainflux.dry3.Length = 10
sandtank.Cycle.rainflux.Repeat = -1
...
# -----------------------------------------------------------------------------
# Boundary Conditions - creating files
# -----------------------------------------------------------------------------

rain_flux = -0.4
nx = sandtank.ComputationalGrid.NX
ny = sandtank.ComputationalGrid.NY
...
sandtank.Patch.x_upper.BCPressure.alltime.Value = hright
...
sandtank.Patch.z_upper.BCPressure.Type = 'FluxFile'
sandtank.Patch.z_upper.BCPressure.Cycle = 'rainflux'
sandtank.Patch.z_upper.BCPressure.rain.FileName = 'rainflux_all.pfb'
sandtank.Patch.z_upper.BCPressure.dry1.FileName = 'dry.pfb'
sandtank.Patch.z_upper.BCPressure.rain_left.FileName = 'rainflux_left.pfb'
sandtank.Patch.z_upper.BCPressure.dry2.FileName = 'dry.pfb'
sandtank.Patch.z_upper.BCPressure.rain_right.FileName = 'rainflux_right.pfb'
sandtank.Patch.z_upper.BCPressure.dry3.FileName = 'dry.pfb'
...
for i in range(RunLength+1):
    press_out = PFData(get_absolute_path(f'sandtank_flux.out.press.{"{:0>5}".format(i)}.pfb'))
